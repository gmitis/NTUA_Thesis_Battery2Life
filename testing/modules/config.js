// endpoint.method.inputObjectForHTTPMETHOD[1-5]
export const valid_input = JSON.parse(open("../test_data/valid_input.json"));
export const invalid_input = JSON.parse(open("../test_data/invalid_input.json"));
